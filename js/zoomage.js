...
Zoomage.prototype = {
    _animateTransform: function () {
        ...
        if (this.isImgLoaded) {
            ...
            // this.canvas.style[this.prefixedTransform] = 'translate(-50%,50%) translateZ(0) scale(' + this.zoomD + ') rotate(' + this.rotate.angle + 'deg)';
        }
    ...
    _setEventListenersTransform: function () {
        ...
        this.imgTexture.addEventListener('load', function (e) {
            ...
            // if( this.imgTexture.width > boxParent ){
            //     this.imgTexture.width = boxParent
            // }
            ...
            // var boxParent = (90 * this.canvas.parentNode.clientWidth) / 100;
            // var diff = ((boxParent - this.imgTexture.width) / 2);
            // var TextureHalfWidth = (this.imgTexture.width / 2);
            //
            // if (diff - TextureHalfWidth <= 0) {
            //     console.log("00", diff)
            //     // this.moveXD = -1 * diff
            // } else {
            //     console.log("11")
            //     // this.moveXD = -1 * (diff - TextureHalfWidth);
            // }
            //
            // // this.moveXD  = -1*(((this.canvas.parentNode.clientWidth -  this.imgTexture.width)/2) - ( this.imgTexture.width / 2))
            // console.log('parentNode', this.canvas.parentNode.clientWidth, 'imgTexture', this.imgTexture.width, 'moveXD', this.moveXD);

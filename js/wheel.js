      ...
      //  alert("cells");
        ...
        cog.each(function () {
            ...
            for (var i = 0; i < 10; i++) {
                ...
                $(this).append('<div></div>').find('div').eq(i).text(n).addClass('quotaFC');

...
pageThirtyOne.endScroll = function () {
    ...
    if ((pageThirtyOne.nextLink != null && pageThirtyOne.nextLink != "") && pageThirtyOne.canCallNextLink) {
        pageThirtyOne.canCallNextLink = false;
       var data = {};
        pageTwentyFour.ajaxForecast("POST", pageThirtyOne.nextLink, pageThirtyOne.manage, data);
    } else {
    }
};
